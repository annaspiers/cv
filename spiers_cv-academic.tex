...
\renewcommand{\arraystretch}{1.2}
\begin{tabularx}{\textwidth}{@{}>{\raggedright}p{5in} >{\raggedleft}X@{}}
\emph{Intern}. The Nature Conservancy Washington (funded by NSF INTERN Grant). & 2022 - present \tabularnewline 

\emph{Researcher}. Forestoration International Flagship Restoration Case Studies. & 2021 - present \tabularnewline 
...
\emph{Undergraduate fellow}. Medicinal Plants and Ethnobotany in Peru. & Summer 2014 \tabularnewline 

\emph{Undergraduate researcher}. Tardigrades of the Berkshires. Williamstown, Ma. & Winter 2014 \tabularnewline %advised by Dr. Joan Edwards.

\emph{Undergraduate researcher}. NSF Research Experience for Undergraduates. & Summer 2013 \tabularnewline %Funded by NSF Award \#1156550: Tardigrade Research in the Canopy (Co-PIs: Drs. William Miller and Meg Lowman). Baldwin City, KS.
